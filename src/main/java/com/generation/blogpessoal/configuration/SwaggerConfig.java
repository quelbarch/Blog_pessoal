    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Projeto desenvolvido por Raquel Barcheta<br><br>" +
                        "Email: <a href='mailto:raquelbarcheta@gmail.com'>raquelbarcheta@gmail.com</a>")
                .version("v0.0.1")
                .license(new License()
                    .name("Github Pessoal")
                    .url("https://github.com/quelbarch"))
                .contact(new Contact()
                    .name("Repositório do Projeto")
                    .url("https://github.com/quelbarch/Blog_pessoal")))
